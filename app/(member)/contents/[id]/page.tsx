...
import { getContentDetail } from "@/lib/mock/content-detail";
import { ArticleDetail } from "@/components/contents/detail/article-detail";
 ...
 * 資料/投稿の詳細は別デザインのため本ルートでは扱わない。データは静的モック参照。
 */
export default async function ContentDetailPage({
  ...
  const related = mockContents.filter((item) => item.id !== id).slice(0, 4);
